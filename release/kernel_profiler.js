/*
Developer Note:
Lightweight per-tick CPU profiler.

Purpose:
- Measure CPU by labeled section
- Keep instrumentation small and easy to reuse
- Feed snapshots into stats_manager
    ...
    return {
      ...
      finalize() {
        ...
        return {
          tick: Game.time,
          cpu: {
            used: Number(totalCpu.toFixed(3)),
            tickCost: Number(tickCost.toFixed(3)),
