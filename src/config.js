...
module.exports = {
  ...
  MEMORY: {
    ...
    PRESSURE_CLEANUP_INTERVAL: 100,
    PRESSURE_CLEANUP_MIN_BUCKET: 2000,
    STATS_HISTORY_LIMIT: 50,
    ROOM_STATS_MAX_AGE: 1000,
    DIAGNOSTIC_TTL: 500,
    COMPLETED_REQUEST_TTL: 5000,
  ...
  */
  ...
  with ops.expand(). Expansions run the full owned-room construction and
  economy path.
  */
  EXPANSION: {
    ENABLED: true,
  ...
  to a stable parent room, build reserved-room infrastructure, and return
  remote source energy home. Keep planning throttled so extra rooms do not add
  owned-room-level CPU every tick.
  */
  RESERVATION: {
    ENABLED: true,
    MIN_PARENT_RCL: 4,
  ...
  */
  ADVANCED: {
    ...
    LABS: {
      ...
      TARGET_MET_UNLOAD_AT: 25,
      MIN_PRODUCT_BATCH: 250,
      REPLAN_INTERVAL: 5,
      TIGHT_REPLAN_MULTIPLIER: 3,
      ALLOW_TIGHT_MODE_REPLAN: true,
      BOOST_TARGETS: {
        UH: 1000,
        UO: 1000,
        KH: 1000,
    ...
    EMPIRE: {
      MINERAL_BALANCING_ENABLED: true,
      TRANSFER_BATCH: 500,
      MIN_SENDER_RESERVE: 500,
      MIN_TERMINAL_ENERGY: 5000,
      MAX_TRANSFER_ENERGY_RATIO: 0.25,
      RUN_INTERVAL: 5,
      MAX_TRANSFERS_PER_TICK: 1,
      SUPPORT_ENABLED: true,
      SUPPORT_MIN_DONOR_RCL: 6,
      SUPPORT_MIN_DONOR_STORAGE_ENERGY: 50000,
      SUPPORT_MAX_PER_TARGET_ROLE: 1,
      SUPPORT_WORKER_PRIORITY: 65,
      SUPPORT_UPGRADER_PRIORITY: 58,
      SUPPORT_CONTROLLER_DOWNGRADE_TICKS: 8000,
    },
  },
